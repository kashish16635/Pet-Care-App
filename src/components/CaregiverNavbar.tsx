...
export function CaregiverNavbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 transition-colors" suppressHydrationWarning>
